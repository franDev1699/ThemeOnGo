...
class ThemeOnGo_Badge_Widget extends \Elementor\Widget_Base {
    ...
    public function get_categories() {
        return [ 'general' ]; // Puede aparecer en la categoría Básica o General
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'content_section',
            [
                'label' => __( 'Contenido del Badge', 'themeongo' ),
        ...
        $this->add_control(
            'icon_class',
            [
                'label' => __( 'Clase del Icono (FontAwesome)', 'themeongo' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => 'fa-solid fa-leaf',
                'description' => 'Ejemplo: fa-solid fa-leaf, fa-solid fa-star',
            ]
        );
        ...
        $this->add_control(
            'badge_title',
            [
                'label' => __( 'Título Principal', 'themeongo' ),
                'type' => \Elementor\Controls_Manager::TEXT,
                'default' => '+10 Años',
            ]
        );
    ...
    protected function render() {
        // Obtenemos los valores desde Elementor
        ...
        ?>
        <!-- Reutilizamos el estilo .floating-badge y .glass-panel de nuestro main.css -->
